            ...
            <div class="grid md:grid-cols-2 gap-6">
                @forelse($ideas as $idea)
                    <x-card href="{{ route('ideas.show', $idea) }}">
                        ...
                        @if($idea->image_path)
                            <div class="rounded-lg overflow-hidden mb-4 -mx-4 -mt-6">
                                <img class="w-full h-48 object-cover" src="{{ asset('storage/' . $idea->image_path) }}" alt="">
                            </div>
                        @endif
                        ...
                        <div class="mt-5 line-clamp-3 prose prose-invert">
